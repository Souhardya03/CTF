							...
							<div className=" move-up flex flex-col justify-center FREAKYHALLOWEEN mt-4">
								<div className="flex items-center justify-center gap-2">
									...
									<div className="trick-or-treats text-lg pt-3">
										Participants are allowed to use any tool (online / offline)
								...
								<div className="flex items-center gap-1">
									...
									<div className="trick-or-treats text-lg pt-3">
										Flag sharing is strictly prohibited. It will cause ban from
										the CTF for both the players
									</div>
								</div>
								...
								<div className="flex  gap-2">
									...
									<div className="flex flex-col justify-center">
										...
										<div className="scary-halloween pl-4">
											...
											more. When players solve them they get a "flag", a secret
											string which can be exchanged for points. The more points
